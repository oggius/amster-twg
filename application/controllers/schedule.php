...
class Schedule extends CI_Controller {
    ...
    public function index()
    {
        ...
        */
        ...
        $this->Meta->setValue('page_title', 'Ближайшие концерты');
        $this->Meta->setValue('page_description', 'Расписание выступлений группы AmsterDam на ближайшее время');
        $metadata = $this->Meta->getData();
        echo $this->twig->render('schedule/index.html', array('meta' => $metadata, 'concerts' => $futureConcerts, 'months' => $months));
    }
}